...
> 2026-07-18 状态更新：本文保留形成时的 UART6 历史分析，文中“前台逐字节接收、没有 DMA、`Cl` 检查被注释”等描述已不符合当前源码。当前 DSM 传输、定长接收、解析重试和 drain 活性边界见 [DSM 传感器协议适配复查](../../03_问题分析与整改/未处理/2026-07-18_DSM传感器协议适配复查.md)。
