...
| [Newhall称重传感器协议/README.md](Newhall称重传感器协议/README.md) | 独立 MSP430FR2476 称重主控的 `19200 8N1` UART 协议归档，包含当前 `0x83` 全量帧、未启用 `0x81/0x82` 组包、下行查询、BCC、字段格式和联调边界；当前不表示 CUBE 已实现接入 |
