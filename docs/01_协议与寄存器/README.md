...
| CPU2 参数存储 | `DEVICE_PARAM_VERSION = 3`，CPU2 `V1.12.0.0` 到当前 `V1.21.6.0` 之间通常不清参数；协议 13 迁移密度倍率，协议 14 补齐 SI Profile 默认参数 | `LTD_MAIN_CPU2/Services/ParamStorage/system_parameter.c`、`../00_构建与版本/CPU2参数存储升级清单.md` |
