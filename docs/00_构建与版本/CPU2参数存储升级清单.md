...
| CPU2 `V1.12.0.0` 到 `V1.21.3.0` 之间升级 | 通常保留 | 确认 FRAM 未损坏即可；`V1.12.1.2`/`V1.12.1.3` 新默认值只在恢复出厂或 FRAM 无效时生效；`V1.20.2.0`、`V1.20.3.0`、`V1.21.0.0`、`V1.21.1.0`、`V1.21.2.0`、`V1.21.3.0` 等后续版本不改变 CPU2 参数存储结构 |
...
| CPU2 `V1.12.0.1` 到当前 `V1.21.3.0` | 3 | 版本 3 内通常不清 | 当前未改变参数存储结构；`V1.12.1.2` 和 `V1.12.1.3` 仅调整恢复出厂默认值，`V1.20.2.0`、`V1.20.3.0`、`V1.21.0.0`、`V1.21.1.0`、`V1.21.2.0`、`V1.21.3.0` 均保持 `DEVICE_PARAM_VERSION` 和 `struct_size` 不变 |
