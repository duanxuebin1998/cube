...
| `../当前程序故障代码清单.md` | 从 CPU2 权威定义整理的 73 项当前故障码清单，可用于核对 CPU3 显示文案 |
...
如需整理故障码定义，先以 `LTD_MAIN_CPU2/Services/ParamStorage/system_parameter.h`、`docs/00_构建与版本/故障码/CPU2/LTD故障代码表.xlsx` 和 `docs/00_构建与版本/故障码/当前程序故障代码清单.md` 为准；本目录表格只同步显示侧需要的辅助信息。跨目录判定见 `D:/CUBE/docs/00_构建与版本/故障代码表权威来源判定.md`。
