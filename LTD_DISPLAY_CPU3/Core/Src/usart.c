...
//PUTCHAR_PROTOTYPE {
//    uint16_t next = (uart1_tx_head + 1) % UART1_TX_BUF_SIZE;
//
//    /* 等待缓冲区有空位 */
//    while (next == uart1_tx_tail);
//
//    uart1_tx_buf[uart1_tx_head] = (uint8_t)ch;
//    uart1_tx_head = next;
//
//    /* 尝试启动DMA发送 */
//    UART1_StartTx();
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    GPIO_InitStruct.Pin = MAIN_BOARD_UART5_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init(MAIN_BOARD_UART5_TX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MAIN_BOARD_UART5_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init(MAIN_BOARD_UART5_RX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(MAIN_BOARD_UART5_TX_GPIO_Port, MAIN_BOARD_UART5_TX_Pin);

    HAL_GPIO_DeInit(MAIN_BOARD_UART5_RX_GPIO_Port, MAIN_BOARD_UART5_RX_Pin);
