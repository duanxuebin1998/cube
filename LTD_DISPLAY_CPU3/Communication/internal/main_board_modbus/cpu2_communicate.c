...
/* 保持寄存器组 5：设备参数中段 */
{FUNCTIONCODE_READ_HOLDREGISTER, HOLDREGISTER_DEVICEPARAM_RESERVED11, (uint16_t) (HOLDREGISTER_DEVICEPARAM_RESERVED24 - HOLDREGISTER_DEVICEPARAM_RESERVED11) },

/* 保持寄存器组 6：AO/指令参数/尺带补偿 */
{FUNCTIONCODE_READ_HOLDREGISTER, HOLDREGISTER_DEVICEPARAM_RESERVED24, (uint16_t) (HOLDREGISTER_DEVICEPARAM_RELAY_ALARM_BASE - HOLDREGISTER_DEVICEPARAM_RESERVED24) },

/* 保持寄存器组 7：继电器方式2配置与元信息 */
