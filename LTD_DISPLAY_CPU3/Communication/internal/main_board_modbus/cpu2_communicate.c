...
#define WIRELESS_PAIRING_STATUS_REGISTER_COUNT ((uint16_t)(REG_ENG - REG_WIRELESS_PAIRING_RESULT))
...
/* 输入寄存器组 3：无线滑环匹配状态 */
{FUNCTIONCODE_READ_INPUTREGISTER, REG_WIRELESS_PAIRING_RESULT, WIRELESS_PAIRING_STATUS_REGISTER_COUNT },
...
/* 保持寄存器组 5：设备参数后半段 */
{FUNCTIONCODE_READ_HOLDREGISTER, HOLDREGISTER_DEVICEPARAM_RESERVED11, (uint16_t) (HOLDREGISTER_DEVICEPARAM_ALARM_HIGH_DO - HOLDREGISTER_DEVICEPARAM_RESERVED11) }
};
