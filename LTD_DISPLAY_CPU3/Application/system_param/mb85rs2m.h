...
/**
 * @brief 写入或设置参数存储中的 WriteMultiData 逻辑。
 *
...
/**
 * @brief 读取参数存储中的 ReadMultiData 逻辑。
 *
 * @param p_array 输入/输出指针。
 * @param startcnt 业务参数。
 * @param length 数据长度。
...
/**
 * @brief 读取参数存储中的 ReadSingleData 逻辑。
 *
 * @param address 地址参数。
...
/**
 * @brief 写入或设置参数存储中的 WriteTwoData 逻辑。
 *
 * @param steps 业务参数。
 * @param circle 业务参数。
 * @param address 地址参数。
...
/**
 * @brief 读取参数存储中的 Test_FRAM_ReadWrite 逻辑。
 */
