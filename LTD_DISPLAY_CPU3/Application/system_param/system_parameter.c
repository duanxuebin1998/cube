...
{(uint8_t*)"密度修正",	0,	COM_NUM_DEVICEPARAM_DENSITYCORRECTION,	HOLDREGISTER_DEVICEPARAM_DENSITYCORRECTION,	2,	false,	-10000,	10000,	(uint8_t*)"kg/m3",	1,	-10000,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"DensityCorr"},
{(uint8_t*)"温度修正",	0,	COM_NUM_DEVICEPARAM_TEMPERATURECORRECTION,	HOLDREGISTER_DEVICEPARAM_TEMPERATURECORRECTION,	2,	false,	-1000,	1000,	(uint8_t*)"℃",	1,	-1000,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"TempCorr"},
