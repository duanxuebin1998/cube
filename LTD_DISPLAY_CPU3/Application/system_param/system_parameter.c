...
struct ParameterMetadata param_meta[] = {
	...
	{(uint8_t*)"称重忽略区",	0,	COM_NUM_DEVICEPARAM_WEIGHT_IGNORE_ZONE,	HOLDREGISTER_DEVICEPARAM_WEIGHT_IGNORE_ZONE,	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"WeightIgnore"},
	...
	{(uint8_t*)"保留14",	0,	COM_NUM_DEVICEPARAM_RESERVED14,	HOLDREGISTER_DEVICEPARAM_RESERVED14,	2,	false,	0,	0,	NULL,	0,	0,	false,	TYPE_INT,	8,	NULL,	(uint8_t*)"Rsv14"},
	...
	{(uint8_t*)"罐底检测模式",	0,	COM_NUM_DEVICEPARAM_BOTTOM_DETECT_MODE,	HOLDREGISTER_DEVICEPARAM_BOTTOM_DETECT_MODE,	2,	true,	0,	3,	NULL,	0,	0,	true,	TYPE_INT,	1,	NULL,	(uint8_t*)"BottomMode"},
	...
	{(uint8_t*)"磁通量D",	0,	COM_NUM_DEVICEPARAM_DENSITYCORRECTION,	HOLDREGISTER_DEVICEPARAM_DENSITYCORRECTION,	2,	false,	-10000,	10000,	NULL,	1,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"DensityCorr"},
	{(uint8_t*)"磁通量T",	0,	COM_NUM_DEVICEPARAM_TEMPERATURECORRECTION,	HOLDREGISTER_DEVICEPARAM_TEMPERATURECORRECTION,	2,	false,	-1000,	1000,	NULL,	1,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"TempCorr"},
	...
	{(uint8_t*)"区间测量上限",	0,	COM_NUM_DEVICEPARAM_INTERVAL_TOPLIMIT,	HOLDREGISTER_DEVICEPARAM_INTERVAL_TOPLIMIT,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"IntTop"},
	{(uint8_t*)"区间测量下限",	0,	COM_NUM_DEVICEPARAM_INTERVAL_BOTTOMLIMIT,	HOLDREGISTER_DEVICEPARAM_INTERVAL_BOTTOMLIMIT,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"IntBottom"},
	...
	{(uint8_t*)"密度点上限",	0,	COM_NUM_DEVICEPARAM_WARTSILA_UPPER_DENSITY_LIMIT,	HOLDREGISTER_DEVICEPARAM_WARTSILA_UPPER_DENSITY_LIMIT,	2,	false,	0,	0,	(uint8_t*)"kg/m3",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"WUpperDen"},
	{(uint8_t*)"密度点下限",	0,	COM_NUM_DEVICEPARAM_WARTSILA_LOWER_DENSITY_LIMIT,	HOLDREGISTER_DEVICEPARAM_WARTSILA_LOWER_DENSITY_LIMIT,	2,	false,	0,	0,	(uint8_t*)"kg/m3",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"WLowerDen"},
	{(uint8_t*)"密度点间距",	0,	COM_NUM_DEVICEPARAM_WARTSILA_DENSITY_INTERVAL,	HOLDREGISTER_DEVICEPARAM_WARTSILA_DENSITY_INTERVAL,	2,	false,	0,	0,	(uint8_t*)"kg/m3",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"WDenStep"},
	...
	{(uint8_t*)"电机上行距离",	0,	COM_NUM_DEVICEPARAM_MOTOR_COMMAND_DISTANCE,	HOLDREGISTER_DEVICEPARAM_MOTOR_COMMAND_DISTANCE,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"MotorDist"},
	...
	/* ==================== 下发指令参数（保持你原来的寄存器宏）==================== */
	{(uint8_t*)"标定液位值",	0,	COM_NUM_CAL_OIL,	HOLDREGISTER_DEVICEPARAM_CALIBRATE_OIL_LEVEL,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"CalOilLvl"},
	{(uint8_t*)"修正液位值",	0,	COM_NUM_CORRECTION_OIL,	HOLDREGISTER_DEVICEPARAM_CALIBRATE_OIL_LEVEL,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"CalOilLvl"},
	{(uint8_t*)"标定水位值",	0,	COM_NUM_CALIBRATE_WATER,	HOLDREGISTER_DEVICEPARAM_CALIBRATE_WATER_LEVEL,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"CalWaterLvl"},
	...
	{(uint8_t*)"电机上行距离",	0,	COM_NUM_RUNUP,	HOLDREGISTER_DEVICEPARAM_MOTOR_COMMAND_DISTANCE,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"MotorDist"},
	{(uint8_t*)"电机下行距离",	0,	COM_NUM_RUNDOWN,	HOLDREGISTER_DEVICEPARAM_MOTOR_COMMAND_DISTANCE,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"MotorDist"},
	{(uint8_t*)"电机上行距离",	0,	COM_NUM_FORCE_RUNUP,	HOLDREGISTER_DEVICEPARAM_MOTOR_COMMAND_DISTANCE,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"MotorDist"},
	{(uint8_t*)"电机下行距离",	0,	COM_NUM_FORCE_RUNDOWN,	HOLDREGISTER_DEVICEPARAM_MOTOR_COMMAND_DISTANCE,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"MotorDist"},
