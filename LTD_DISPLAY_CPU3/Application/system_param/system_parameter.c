...
{(uint8_t*)"电机限速",	0,	COM_NUM_DEVICEPARAM_MAX_MOTOR_SPEED,	HOLDREGISTER_DEVICEPARAM_MAX_MOTOR_SPEED,	2,	false,	0,	0,	NULL,	2,	0,	true,	TYPE_INT,	3,	NULL,	(uint8_t*)"MaxMotorSpd"},
...
{(uint8_t*)"液位找液阈值",	0,	COM_NUM_DEVICEPARAM_OILLEVELTHRESHOLD,	HOLDREGISTER_DEVICEPARAM_OILLEVELTHRESHOLD,	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"OilLvlTh"},
{(uint8_t*)"液位滞后阈值",	0,	COM_NUM_DEVICEPARAM_OILLEVEL_HYSTERESIS_THRESHOLD,	HOLDREGISTER_DEVICEPARAM_OILLEVEL_HYSTERESIS_THRESHOLD,	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"HysTh"},
...
{(uint8_t*)"水位跟随电容阈值",	0,	COM_NUM_DEVICEPARAM_WATER_CAP_THRESHOLD,	HOLDREGISTER_DEVICEPARAM_WATER_CAP_THRESHOLD,	2,	false,	0,	0,	NULL,	3,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"WaterCapTh"},
{(uint8_t*)"水位寻找电容阈值",	0,	COM_NUM_DEVICEPARAM_WATER_FIND_CAP_THRESHOLD,	HOLDREGISTER_DEVICEPARAM_WATER_FIND_CAP_THRESHOLD,	2,	false,	0,	0,	NULL,	3,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"WaterFind"},
...
{(uint8_t*)"探底角度阈值",	0,	COM_NUM_DEVICEPARAM_BOTTOM_ANGLE_THRESHOLD,	HOLDREGISTER_DEVICEPARAM_BOTTOM_ANGLE_THRESHOLD,	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"BottomAngTh"},
...
{(uint8_t*)"水位滞后电容阈值", 0, COM_NUM_DEVICEPARAM_WATER_LAG_CAP_THRESHOLD, HOLDREGISTER_DEVICEPARAM_WATER_LAG_CAP_THRESHOLD, 2, false, 0, 0, NULL, 3, 0, true, TYPE_INT, 6, NULL, (uint8_t*)"WaterLagCap"},
...
{(uint8_t*)"AO输出范围起点电流",	0,	COM_NUM_DEVICEPARAM_CURRENT_RANGE_START_mA,	HOLDREGISTER_DEVICEPARAM_CURRENT_RANGE_START_mA,	2,	true,	0,	3000,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"RangeStart"},
{(uint8_t*)"AO输出范围终点电流",	0,	COM_NUM_DEVICEPARAM_CURRENT_RANGE_END_mA,	HOLDREGISTER_DEVICEPARAM_CURRENT_RANGE_END_mA,	2,	true,	0,	3000,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"RangeEnd"},
{(uint8_t*)"AO高限报警电流",	0,	COM_NUM_DEVICEPARAM_ALARM_HIGH_AO,	HOLDREGISTER_DEVICEPARAM_ALARM_HIGH_AO,	2,	true,	0,	3000,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"AlarmHiAO"},
{(uint8_t*)"AO低限报警电流",	0,	COM_NUM_DEVICEPARAM_ALARM_LOW_AO,	HOLDREGISTER_DEVICEPARAM_ALARM_LOW_AO,	2,	true,	0,	3000,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"AlarmLoAO"},
{(uint8_t*)"AO初始电流",	0,	COM_NUM_DEVICEPARAM_INITIAL_CURRENT_mA,	HOLDREGISTER_DEVICEPARAM_INITIAL_CURRENT_mA,	2,	true,	0,	3000,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"InitCurrent"},
{(uint8_t*)"AO高位电流",	0,	COM_NUM_DEVICEPARAM_AO_HIGH_CURRENT_mA,	HOLDREGISTER_DEVICEPARAM_AO_HIGH_CURRENT_mA,	2,	true,	0,	3000,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"HighCurrent"},
...
{(uint8_t*)"R1高高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY1_HH_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_HH_ALARM_VALUE(0U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R1HHValue"},
{(uint8_t*)"R1高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY1_H_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_H_ALARM_VALUE(0U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R1HValue"},
{(uint8_t*)"R1低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY1_L_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_L_ALARM_VALUE(0U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R1LValue"},
{(uint8_t*)"R1低低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY1_LL_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_LL_ALARM_VALUE(0U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R1LLValue"},
{(uint8_t*)"R1报警滞回",	0,	COM_NUM_DEVICEPARAM_RELAY1_ALARM_HYSTERESIS,	HOLDREGISTER_DEVICEPARAM_RELAY_ALARM_HYSTERESIS(0U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R1Hysteresis"},
...
{(uint8_t*)"R2高高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY2_HH_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_HH_ALARM_VALUE(1U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R2HHValue"},
{(uint8_t*)"R2高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY2_H_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_H_ALARM_VALUE(1U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R2HValue"},
{(uint8_t*)"R2低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY2_L_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_L_ALARM_VALUE(1U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R2LValue"},
{(uint8_t*)"R2低低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY2_LL_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_LL_ALARM_VALUE(1U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R2LLValue"},
{(uint8_t*)"R2报警滞回",	0,	COM_NUM_DEVICEPARAM_RELAY2_ALARM_HYSTERESIS,	HOLDREGISTER_DEVICEPARAM_RELAY_ALARM_HYSTERESIS(1U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R2Hysteresis"},
...
{(uint8_t*)"R3高高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY3_HH_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_HH_ALARM_VALUE(2U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R3HHValue"},
{(uint8_t*)"R3高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY3_H_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_H_ALARM_VALUE(2U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R3HValue"},
{(uint8_t*)"R3低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY3_L_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_L_ALARM_VALUE(2U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R3LValue"},
{(uint8_t*)"R3低低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY3_LL_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_LL_ALARM_VALUE(2U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R3LLValue"},
{(uint8_t*)"R3报警滞回",	0,	COM_NUM_DEVICEPARAM_RELAY3_ALARM_HYSTERESIS,	HOLDREGISTER_DEVICEPARAM_RELAY_ALARM_HYSTERESIS(2U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R3Hysteresis"},
...
{(uint8_t*)"R4高高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY4_HH_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_HH_ALARM_VALUE(3U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R4HHValue"},
{(uint8_t*)"R4高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY4_H_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_H_ALARM_VALUE(3U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R4HValue"},
{(uint8_t*)"R4低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY4_L_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_L_ALARM_VALUE(3U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R4LValue"},
{(uint8_t*)"R4低低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY4_LL_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_LL_ALARM_VALUE(3U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R4LLValue"},
{(uint8_t*)"R4报警滞回",	0,	COM_NUM_DEVICEPARAM_RELAY4_ALARM_HYSTERESIS,	HOLDREGISTER_DEVICEPARAM_RELAY_ALARM_HYSTERESIS(3U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	8,	NULL,	(uint8_t*)"R4Hysteresis"},
