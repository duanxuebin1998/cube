...
{(uint8_t*)"液位找液阈值",	0,	COM_NUM_DEVICEPARAM_OILLEVELTHRESHOLD,	HOLDREGISTER_DEVICEPARAM_OILLEVELTHRESHOLD,	2,	false,	0,	0,	(uint8_t*)"kg/m3",	2,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"OilLvlTh"},
...
{(uint8_t*)"液位滞后阈值",	0,	COM_NUM_DEVICEPARAM_OILLEVEL_HYSTERESIS_THRESHOLD,	HOLDREGISTER_DEVICEPARAM_OILLEVEL_HYSTERESIS_THRESHOLD,	2,	false,	0,	0,	(uint8_t*)"kg/m3",	2,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"HysTh"},
...
{(uint8_t*)"水位稳定距离",	0,	COM_NUM_DEVICEPARAM_WATER_STABLE_THRESHOLD,	HOLDREGISTER_DEVICEPARAM_WATER_STABLE_THRESHOLD,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"Rsv15"},
