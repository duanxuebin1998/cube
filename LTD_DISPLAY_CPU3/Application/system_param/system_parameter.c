...
{(uint8_t*)"液位定时矫正开关", 0, COM_NUM_DEVICEPARAM_LEVEL_REFERENCE_REFRESH_ENABLE, HOLDREGISTER_DEVICEPARAM_LEVEL_REFERENCE_REFRESH_ENABLE, 2, true, 0, 1, NULL, 0, 0, true, TYPE_INT, 1, ret_arr_word, (uint8_t*)"TimeCorr"},
{(uint8_t*)"液位定时矫正周期", 0, COM_NUM_DEVICEPARAM_LEVEL_REFERENCE_REFRESH_INTERVAL_MIN, HOLDREGISTER_DEVICEPARAM_LEVEL_REFERENCE_REFRESH_INTERVAL_MIN, 2, true, 60, 10080, (uint8_t*)"min", 0, 0, true, TYPE_INT, 5, NULL, (uint8_t*)"CorrPer"},
...
{(uint8_t*)"探底扭力阈值",	0,	COM_NUM_DEVICEPARAM_BOTTOM_WEIGHT_THRESHOLD,	HOLDREGISTER_DEVICEPARAM_BOTTOM_WEIGHT_THRESHOLD,	2,	true,	0,	2147483647,	NULL,	0,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"BottomTqTh"},
