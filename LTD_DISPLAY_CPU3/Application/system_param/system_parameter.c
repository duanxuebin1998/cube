...
{(uint8_t*)"空载称重",	0,	COM_NUM_DEVICEPARAM_EMPTY_WEIGHT,	HOLDREGISTER_DEVICEPARAM_EMPTY_WEIGHT,	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"EmptyWt"},
{(uint8_t*)"空载称重上限",	0,	COM_NUM_DEVICEPARAM_EMPTY_WEIGHT_UPPER_LIMIT,	HOLDREGISTER_DEVICEPARAM_EMPTY_WEIGHT_UPPER_LIMIT,	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"EmptyWtHi"},
{(uint8_t*)"空载称重下限",	0,	COM_NUM_DEVICEPARAM_EMPTY_WEIGHT_LOWER_LIMIT,	HOLDREGISTER_DEVICEPARAM_EMPTY_WEIGHT_LOWER_LIMIT,	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"EmptyWtLo"},
{(uint8_t*)"满载称重",	0,	COM_NUM_DEVICEPARAM_FULL_WEIGHT,	HOLDREGISTER_DEVICEPARAM_FULL_WEIGHT,	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"FullWt"},
{(uint8_t*)"满载称重上限",	0,	COM_NUM_DEVICEPARAM_FULL_WEIGHT_UPPER_LIMIT,	HOLDREGISTER_DEVICEPARAM_FULL_WEIGHT_UPPER_LIMIT,	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"FullWtHi"},
{(uint8_t*)"满载称重下限",	0,	COM_NUM_DEVICEPARAM_FULL_WEIGHT_LOWER_LIMIT,	HOLDREGISTER_DEVICEPARAM_FULL_WEIGHT_LOWER_LIMIT,	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"FullWtLo"},
...
{(uint8_t*)"液位找液阈值",	0,	COM_NUM_DEVICEPARAM_OILLEVELTHRESHOLD,	HOLDREGISTER_DEVICEPARAM_OILLEVELTHRESHOLD,	2,	false,	0,	0,	(uint8_t*)"Hz",	0,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"OilLvlTh"},
{(uint8_t*)"液位滞后阈值",	0,	COM_NUM_DEVICEPARAM_OILLEVEL_HYSTERESIS_THRESHOLD,	HOLDREGISTER_DEVICEPARAM_OILLEVEL_HYSTERESIS_THRESHOLD,	2,	false,	0,	0,	(uint8_t*)"Hz",	0,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"HysTh"},
...
{(uint8_t*)"探底称重阈值",	0,	COM_NUM_DEVICEPARAM_BOTTOM_WEIGHT_THRESHOLD,	HOLDREGISTER_DEVICEPARAM_BOTTOM_WEIGHT_THRESHOLD,	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"BottomWtTh"},
...
{(uint8_t*)"磁通量D",	0,	COM_NUM_DEVICEPARAM_DENSITYCORRECTION,	HOLDREGISTER_DEVICEPARAM_DENSITYCORRECTION,	2,	false,	-10000,	10000,	(uint8_t*)"kg/m3",	1,	-10000,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"DensityCorr"},
...
{(uint8_t*)"AO起点液位",	0,	COM_NUM_DEVICEPARAM_AO_START_LEVEL,	HOLDREGISTER_DEVICEPARAM_AO_START_LEVEL,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"AOStartLvl"},
{(uint8_t*)"AO终点液位",	0,	COM_NUM_DEVICEPARAM_AO_END_LEVEL,	HOLDREGISTER_DEVICEPARAM_AO_END_LEVEL,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"AOEndLvl"},

{(uint8_t*)"AO正常起点电流",	0,	COM_NUM_DEVICEPARAM_AO_NORMAL_CURRENT_START_mA,	HOLDREGISTER_DEVICEPARAM_AO_NORMAL_CURRENT_START_mA,	2,	true,	400,	2000,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"AONormCurS"},
{(uint8_t*)"AO正常终点电流",	0,	COM_NUM_DEVICEPARAM_AO_NORMAL_CURRENT_END_mA,	HOLDREGISTER_DEVICEPARAM_AO_NORMAL_CURRENT_END_mA,	2,	true,	400,	2000,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"AONormCurE"},
{(uint8_t*)"AO高报警液位",	0,	COM_NUM_DEVICEPARAM_AO_HIGH_ALARM_LEVEL,	HOLDREGISTER_DEVICEPARAM_AO_HIGH_ALARM_LEVEL,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"AOHighLvl"},
{(uint8_t*)"AO低报警液位",	0,	COM_NUM_DEVICEPARAM_AO_LOW_ALARM_LEVEL,	HOLDREGISTER_DEVICEPARAM_AO_LOW_ALARM_LEVEL,	2,	false,	0,	0,	(uint8_t*)"mm",	1,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"AOLowLvl"},
{(uint8_t*)"AO初始电流",	0,	COM_NUM_DEVICEPARAM_INITIAL_CURRENT_mA,	HOLDREGISTER_DEVICEPARAM_INITIAL_CURRENT_mA,	2,	true,	320,	2400,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"AOInitCur"},
{(uint8_t*)"AO高位电流",	0,	COM_NUM_DEVICEPARAM_AO_HIGH_CURRENT_mA,	HOLDREGISTER_DEVICEPARAM_AO_HIGH_CURRENT_mA,	2,	true,	320,	2400,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"AOHighCur"},
{(uint8_t*)"AO低位电流",	0,	COM_NUM_DEVICEPARAM_AO_LOW_CURRENT_mA,	HOLDREGISTER_DEVICEPARAM_AO_LOW_CURRENT_mA,	2,	true,	320,	2400,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"AOLowCur"},
{(uint8_t*)"AO故障电流",	0,	COM_NUM_DEVICEPARAM_FAULT_CURRENT_mA,	HOLDREGISTER_DEVICEPARAM_FAULT_CURRENT_mA,	2,	true,	320,	2400,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"AOFaultCur"},
{(uint8_t*)"AO调试电流",	0,	COM_NUM_DEVICEPARAM_DEBUG_CURRENT_mA,	HOLDREGISTER_DEVICEPARAM_DEBUG_CURRENT_mA,	2,	true,	320,	2400,	(uint8_t*)"mA",	2,	0,	true,	TYPE_INT,	5,	NULL,	(uint8_t*)"AODebugCur"},
...
{(uint8_t*)"R1输出报警组合",	0,	COM_NUM_DEVICEPARAM_RELAY1_DIGITAL_SOURCE,	HOLDREGISTER_DEVICEPARAM_RELAY_DIGITAL_SOURCE(0U),	2,	true,	0,	7,	NULL,	0,	0,	true,	TYPE_INT,	2,	ret_arr_word,	(uint8_t*)"R1OutAlarm"},
{(uint8_t*)"R1接点类型",	0,	COM_NUM_DEVICEPARAM_RELAY1_CONTACT_TYPE,	HOLDREGISTER_DEVICEPARAM_RELAY_CONTACT_TYPE(0U),	2,	true,	0,	1,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R1Contact"},
...
{(uint8_t*)"R1无效值报警策略",	0,	COM_NUM_DEVICEPARAM_RELAY1_ERROR_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_ERROR_VALUE(0U),	2,	true,	0,	5,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R1Invalid"},
...
{(uint8_t*)"R1高高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY1_HH_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_HH_ALARM_VALUE(0U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R1HHValue"},
{(uint8_t*)"R1高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY1_H_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_H_ALARM_VALUE(0U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R1HValue"},
{(uint8_t*)"R1低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY1_L_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_L_ALARM_VALUE(0U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R1LValue"},
{(uint8_t*)"R1低低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY1_LL_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_LL_ALARM_VALUE(0U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R1LLValue"},
{(uint8_t*)"R1报警滞回",	0,	COM_NUM_DEVICEPARAM_RELAY1_ALARM_HYSTERESIS,	HOLDREGISTER_DEVICEPARAM_RELAY_ALARM_HYSTERESIS(0U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R1Hysteresis"},
{(uint8_t*)"R1阻尼系数",	0,	COM_NUM_DEVICEPARAM_RELAY1_DAMPING_FACTOR,	HOLDREGISTER_DEVICEPARAM_RELAY_DAMPING_FACTOR(0U),	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"R1Damping"},
{(uint8_t*)"R1清除锁存报警",	0,	COM_NUM_DEVICEPARAM_RELAY1_CLEAR_ALARM,	HOLDREGISTER_DEVICEPARAM_RELAY_CLEAR_ALARM(0U),	2,	true,	0,	1,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R1Clear"},
...
{(uint8_t*)"R2输出报警组合",	0,	COM_NUM_DEVICEPARAM_RELAY2_DIGITAL_SOURCE,	HOLDREGISTER_DEVICEPARAM_RELAY_DIGITAL_SOURCE(1U),	2,	true,	0,	7,	NULL,	0,	0,	true,	TYPE_INT,	2,	ret_arr_word,	(uint8_t*)"R2OutAlarm"},
{(uint8_t*)"R2接点类型",	0,	COM_NUM_DEVICEPARAM_RELAY2_CONTACT_TYPE,	HOLDREGISTER_DEVICEPARAM_RELAY_CONTACT_TYPE(1U),	2,	true,	0,	1,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R2Contact"},
...
{(uint8_t*)"R2无效值报警策略",	0,	COM_NUM_DEVICEPARAM_RELAY2_ERROR_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_ERROR_VALUE(1U),	2,	true,	0,	5,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R2Invalid"},
...
{(uint8_t*)"R2高高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY2_HH_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_HH_ALARM_VALUE(1U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R2HHValue"},
{(uint8_t*)"R2高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY2_H_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_H_ALARM_VALUE(1U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R2HValue"},
{(uint8_t*)"R2低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY2_L_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_L_ALARM_VALUE(1U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R2LValue"},
{(uint8_t*)"R2低低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY2_LL_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_LL_ALARM_VALUE(1U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R2LLValue"},
{(uint8_t*)"R2报警滞回",	0,	COM_NUM_DEVICEPARAM_RELAY2_ALARM_HYSTERESIS,	HOLDREGISTER_DEVICEPARAM_RELAY_ALARM_HYSTERESIS(1U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R2Hysteresis"},
{(uint8_t*)"R2阻尼系数",	0,	COM_NUM_DEVICEPARAM_RELAY2_DAMPING_FACTOR,	HOLDREGISTER_DEVICEPARAM_RELAY_DAMPING_FACTOR(1U),	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"R2Damping"},
{(uint8_t*)"R2清除锁存报警",	0,	COM_NUM_DEVICEPARAM_RELAY2_CLEAR_ALARM,	HOLDREGISTER_DEVICEPARAM_RELAY_CLEAR_ALARM(1U),	2,	true,	0,	1,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R2Clear"},
...
{(uint8_t*)"R3输出报警组合",	0,	COM_NUM_DEVICEPARAM_RELAY3_DIGITAL_SOURCE,	HOLDREGISTER_DEVICEPARAM_RELAY_DIGITAL_SOURCE(2U),	2,	true,	0,	7,	NULL,	0,	0,	true,	TYPE_INT,	2,	ret_arr_word,	(uint8_t*)"R3OutAlarm"},
{(uint8_t*)"R3接点类型",	0,	COM_NUM_DEVICEPARAM_RELAY3_CONTACT_TYPE,	HOLDREGISTER_DEVICEPARAM_RELAY_CONTACT_TYPE(2U),	2,	true,	0,	1,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R3Contact"},
...
{(uint8_t*)"R3无效值报警策略",	0,	COM_NUM_DEVICEPARAM_RELAY3_ERROR_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_ERROR_VALUE(2U),	2,	true,	0,	5,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R3Invalid"},
...
{(uint8_t*)"R3高高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY3_HH_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_HH_ALARM_VALUE(2U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R3HHValue"},
{(uint8_t*)"R3高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY3_H_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_H_ALARM_VALUE(2U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R3HValue"},
{(uint8_t*)"R3低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY3_L_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_L_ALARM_VALUE(2U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R3LValue"},
{(uint8_t*)"R3低低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY3_LL_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_LL_ALARM_VALUE(2U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R3LLValue"},
{(uint8_t*)"R3报警滞回",	0,	COM_NUM_DEVICEPARAM_RELAY3_ALARM_HYSTERESIS,	HOLDREGISTER_DEVICEPARAM_RELAY_ALARM_HYSTERESIS(2U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R3Hysteresis"},
{(uint8_t*)"R3阻尼系数",	0,	COM_NUM_DEVICEPARAM_RELAY3_DAMPING_FACTOR,	HOLDREGISTER_DEVICEPARAM_RELAY_DAMPING_FACTOR(2U),	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"R3Damping"},
{(uint8_t*)"R3清除锁存报警",	0,	COM_NUM_DEVICEPARAM_RELAY3_CLEAR_ALARM,	HOLDREGISTER_DEVICEPARAM_RELAY_CLEAR_ALARM(2U),	2,	true,	0,	1,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R3Clear"},
...
{(uint8_t*)"R4输出报警组合",	0,	COM_NUM_DEVICEPARAM_RELAY4_DIGITAL_SOURCE,	HOLDREGISTER_DEVICEPARAM_RELAY_DIGITAL_SOURCE(3U),	2,	true,	0,	7,	NULL,	0,	0,	true,	TYPE_INT,	2,	ret_arr_word,	(uint8_t*)"R4OutAlarm"},
{(uint8_t*)"R4接点类型",	0,	COM_NUM_DEVICEPARAM_RELAY4_CONTACT_TYPE,	HOLDREGISTER_DEVICEPARAM_RELAY_CONTACT_TYPE(3U),	2,	true,	0,	1,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R4Contact"},
...
{(uint8_t*)"R4无效值报警策略",	0,	COM_NUM_DEVICEPARAM_RELAY4_ERROR_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_ERROR_VALUE(3U),	2,	true,	0,	5,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R4Invalid"},
...
{(uint8_t*)"R4高高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY4_HH_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_HH_ALARM_VALUE(3U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R4HHValue"},
{(uint8_t*)"R4高报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY4_H_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_H_ALARM_VALUE(3U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R4HValue"},
{(uint8_t*)"R4低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY4_L_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_L_ALARM_VALUE(3U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R4LValue"},
{(uint8_t*)"R4低低报警阈值",	0,	COM_NUM_DEVICEPARAM_RELAY4_LL_ALARM_VALUE,	HOLDREGISTER_DEVICEPARAM_RELAY_LL_ALARM_VALUE(3U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R4LLValue"},
{(uint8_t*)"R4报警滞回",	0,	COM_NUM_DEVICEPARAM_RELAY4_ALARM_HYSTERESIS,	HOLDREGISTER_DEVICEPARAM_RELAY_ALARM_HYSTERESIS(3U),	2,	false,	0,	0,	NULL,	1,	0,	true,	TYPE_FLOAT,	7,	NULL,	(uint8_t*)"R4Hysteresis"},
{(uint8_t*)"R4阻尼系数",	0,	COM_NUM_DEVICEPARAM_RELAY4_DAMPING_FACTOR,	HOLDREGISTER_DEVICEPARAM_RELAY_DAMPING_FACTOR(3U),	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	4,	NULL,	(uint8_t*)"R4Damping"},
{(uint8_t*)"R4清除锁存报警",	0,	COM_NUM_DEVICEPARAM_RELAY4_CLEAR_ALARM,	HOLDREGISTER_DEVICEPARAM_RELAY_CLEAR_ALARM(3U),	2,	true,	0,	1,	NULL,	0,	0,	true,	TYPE_INT,	1,	ret_arr_word,	(uint8_t*)"R4Clear"},
...
{(uint8_t*)"密度手输值",	0,	COM_NUM_SCREEN_INPUT_D,	HOLDREGISTER_CPU3_IN_D,	2,	true,	0,	20000,	(uint8_t*)"kg/m3",	1,	0,	true,	TYPE_INT,	6,	NULL,	(uint8_t*)"InD"},
