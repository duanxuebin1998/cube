...
{(uint8_t*)"称重忽略区",	0,	COM_NUM_DEVICEPARAM_WEIGHT_IGNORE_ZONE,	HOLDREGISTER_DEVICEPARAM_WEIGHT_IGNORE_ZONE,	2,	false,	0,	0,	NULL,	0,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"WeightIgnore"},
...
{(uint8_t*)"密度点上限",	0,	COM_NUM_DEVICEPARAM_WARTSILA_UPPER_DENSITY_LIMIT,	HOLDREGISTER_DEVICEPARAM_WARTSILA_UPPER_DENSITY_LIMIT,	2,	false,	0,	0,	(uint8_t*)"kg/m3",	1,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"WUpperDen"},
{(uint8_t*)"密度点下限",	0,	COM_NUM_DEVICEPARAM_WARTSILA_LOWER_DENSITY_LIMIT,	HOLDREGISTER_DEVICEPARAM_WARTSILA_LOWER_DENSITY_LIMIT,	2,	false,	0,	0,	(uint8_t*)"kg/m3",	1,	0,	true,	TYPE_INT,	7,	NULL,	(uint8_t*)"WLowerDen"},
