...
//
	 ...
	 stpr_writeInt(tmc5130, TMC5130_D1,			20*32);			// must be != 0 !!!!!!!
	 stpr_writeInt(tmc5130, DMAX, 				10*32);            //DMAX = 700 Deceleration above V1
	 ...
	 stpr_writeInt(tmc5130, TMC5130_XTARGET,	0x00000000);     //XTARGET=0
	   value = SET_IHOLD(5) | SET_IRUN(10) | SET_IHOLDDELAY(7);      //
