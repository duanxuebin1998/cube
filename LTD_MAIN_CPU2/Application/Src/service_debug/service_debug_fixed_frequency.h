/*
 * service_debug_fixed_frequency.h
 *
 * 文件职责：声明固定频率液位搜索维护命令的配置查询与执行入口。
 */

#ifndef INC_SERVICE_DEBUG_FIXED_FREQUENCY_H_
/* INC_SERVICE_DEBUG_FIXED_FREQUENCY_H_ 是本头文件的包含保护标记；首次展开后置位，防止重复包含造成类型或接口重复定义。 */
#define INC_SERVICE_DEBUG_FIXED_FREQUENCY_H_
...
#endif /* INC_SERVICE_DEBUG_FIXED_FREQUENCY_H_ */
