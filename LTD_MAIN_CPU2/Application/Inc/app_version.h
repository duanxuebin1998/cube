...
#define CPU2_APP_VERSION_MINOR      42u /* CPU2 应用次版本号。 */
#define CPU2_APP_VERSION_PATCH      5u /* CPU2 应用修订版本号。 */
#define CPU2_APP_VERSION_BUILD      1u /* CPU2 应用构建版本号。 */
...
#define CPU2_APP_VERSION_STRING "V1.42.5.1" /* CPU2 应用版本字符串。 */
