...
#define HART_TXD2_Pin GPIO_PIN_5
#define HART_TXD2_GPIO_Port GPIOD
#define HART_RXD2_Pin GPIO_PIN_6
...
#define AD5421_SPI3_MISO_Pin GPIO_PIN_4
#define AD5421_SPI3_MISO_GPIO_Port GPIOB
#define AD5421_SPI3_MOSI_Pin GPIO_PIN_5
