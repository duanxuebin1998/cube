...
EXPECTED_SHORT_NAMES = {
    ...
    "COM_NUM_DEVICEPARAM_CURRENT_RANGE_START_mA": "起点电流",
    "COM_NUM_DEVICEPARAM_CURRENT_RANGE_END_mA": "终点电流",
    "COM_NUM_DEVICEPARAM_ALARM_HIGH_AO": "高限报警",
    "COM_NUM_DEVICEPARAM_ALARM_LOW_AO": "低限报警",
...
def main() -> int:
    ...
    too_wide = [
        ...
        if text_width(name) > OLED_LINE8_6
    ]
