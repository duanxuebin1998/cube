...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MOTOR_SPI2_CS_Pin|AD5421_SPI3_CSB6_Pin|AD5421_LDAC_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_Init(ENCODE_SPI5_CS_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : MOTOR_SPI2_CS_Pin AD5421_SPI3_CSB6_Pin AD5421_LDAC_Pin */
  GPIO_InitStruct.Pin = MOTOR_SPI2_CS_Pin|AD5421_SPI3_CSB6_Pin|AD5421_LDAC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : DRV_ENN_Pin */
  ...
  /*Configure GPIO pins : RELAY2_NC_Pin RELAY2_NO_Pin */
  GPIO_InitStruct.Pin = RELAY2_NC_Pin|RELAY2_NO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : RELAY4_NC_Pin RELAY4_NO_Pin */
  GPIO_InitStruct.Pin = RELAY4_NC_Pin|RELAY4_NO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(AD5421_FAULT_GPIO_Port, &GPIO_InitStruct);
