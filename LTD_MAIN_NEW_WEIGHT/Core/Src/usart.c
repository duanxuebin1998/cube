...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    GPIO_InitStruct.Pin = CPU2_TXD5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init(CPU2_TXD5_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CPU2_RXD5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init(CPU2_RXD5_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(CPU2_TXD5_GPIO_Port, CPU2_TXD5_Pin);

    HAL_GPIO_DeInit(CPU2_RXD5_GPIO_Port, CPU2_RXD5_Pin);
