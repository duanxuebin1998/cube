...
typedef enum {
    ...
    MOTOR_FAIL_SETTING = 0X00110001,    // 电机设置失败
    MOTOR_UNKNOWN_FEEDBACK = 0X00110002,// 未知反馈
    MOTOR_RESET_FAIL = 0X00110003,      // 复位失败
    MOTOR_DISABLED = 0X00110004,        // 电机被禁止
    MOTOR_ALARM_TRIGGERED = 0X00110005, // 电机报警
    MOTOR_STEP_ERROR = 0X00110006,      // 步进数错误
	MOTOR_CHARGE_PUMP_UNDER_VOLTAGE = 0X00110007,     // 欠压故障
    MOTOR_OVERTEMPERATURE = 0X00110008, // 过温故障
