...
//	MEASUREMENT_OVERSPEED = 0x000F0004, // 液位变化超速
	...
	MEASUREMENT_OILLEVEL_HIGH = 0x000F0007, // 液位值过高，超过罐高
	MEASUREMENT_OILLEVEL_LOW = 0x000F0008, // 向下未找到液位值
	MEASUREMENT_OILLEVEL_NOTFOUND = 0x000F0009, // 向上未找到液位值
	MEASUREMENT_WEIGHT_DOWN_FAIL = 0x000F000A, // 下行寻重失败,找罐底失败
	MEASUREMENT_WEIGHT_UP_FAIL = 0x000F000B, // 上行寻重失败，找零点失败
	MEASUREMENT_OVERSPEED = 0x000F000F, // 液位变化超速
