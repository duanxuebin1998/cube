...
void TMC5130_Run(TMC5130TypeDef *handle, int32_t velocity)
{
	...
	// Set direction
	TMC5130_Write_Register(handle, TMC5130_RAMPMODE,
...
void TMC5130_Move_To(TMC5130TypeDef *handle, int32_t position,
...
{
	return TMC5130_FIELD_READ(handle, TMC5130_IHOLD_IRUN, TMC5130_IRUN_MASK,
			TMC5130_IRUN_SHIFT);
}

void TMC5130_Set_I_MAX(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_IHOLD_IRUN, TMC5130_IRUN_MASK,
			TMC5130_IRUN_SHIFT, value);
}

// Standby current
int32_t TMC5130_Get_I_STBY(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_IHOLD_IRUN, TMC5130_IHOLD_MASK,
			TMC5130_IHOLD_SHIFT);
}

void TMC5130_Set_I_STBY(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_IHOLD_IRUN, TMC5130_IHOLD_MASK,
			TMC5130_IHOLD_SHIFT, value);
}

// Position reached flag
int32_t TMC5130_Get_Position_Flag(TMC5130TypeDef *handle)
{
	return (TMC5130_Read_Register(handle, TMC5130_RAMPSTAT)
...
{
	return (TMC5130_Read_Register(handle, TMC5130_RAMPSTAT) & TMC5130_RS_STOPR) ?
			0 : 1;
}
...
{
	return (TMC5130_Read_Register(handle, TMC5130_RAMPSTAT) & TMC5130_RS_STOPL) ?
			0 : 1;
}
...
void TMC5130_Set_Auto_Right_Stop(TMC5130TypeDef *handle, int32_t value)
{
	...
	if (value == 0)
		TMC5130_Write_Register(handle, TMC5130_SWMODE,
...
{
	return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_VHIGHCHM_MASK,
			TMC5130_VHIGHCHM_SHIFT);
}

void TMC5130_Set_HS_Chopper_Mode(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_VHIGHCHM_MASK,
			TMC5130_VHIGHCHM_SHIFT, value);
}

// High speed fullstep mode
int32_t TMC5130_Get_FS_Mode(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_VHIGHFS_MASK,
			TMC5130_VHIGHFS_SHIFT);
}

void TMC5130_Set_FS_Mode(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_VHIGHFS_MASK,
			TMC5130_VHIGHFS_SHIFT, value);
}
...
{
	return TMC5130_FIELD_READ(handle, TMC5130_RAMPMODE, TMC5130_RAMPMODE_MASK,
			TMC5130_RAMPMODE_SHIFT);
}

void TMC5130_Set_Ramp_Type(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_RAMPMODE, TMC5130_RAMPMODE_MASK,
			TMC5130_RAMPMODE_SHIFT, value);
}

// Analog I Scale
int32_t TMC5130_Get_Analog_I_Scale(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_GCONF,
...
{
	TMC5130_FIELD_WRITE(handle, TMC5130_GCONF, TMC5130_I_SCALE_ANALOG_MASK,
			TMC5130_I_SCALE_ANALOG_SHIFT, value);
}
...
{
	TMC5130_FIELD_WRITE(handle, TMC5130_GCONF, TMC5130_INTERNAL_RSENSE_MASK,
			TMC5130_INTERNAL_RSENSE_SHIFT, value);
}
...
{
	return 256
			>> TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_MRES_MASK,
					TMC5130_MRES_SHIFT);
}
...
void TMC5130_Set_Microstep_Resolution(TMC5130TypeDef *handle, int32_t value)
{
	...
	if (value != -1)
	{
		TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_MRES_MASK,
				TMC5130_MRES_SHIFT, value);
	}
	else
	{
		//errors |= TMC_ERROR_VALUE;
...
{
	return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_TBL_MASK,
			TMC5130_TBL_SHIFT);
}

void TMC5130_Set_Chopper_Blank_Time(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_TBL_MASK,
			TMC5130_TBL_SHIFT, value);
}

// Constant TOff Mode
int32_t TMC5130_Get_CONST_Toff_Mode(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_CHM_MASK,
			TMC5130_CHM_SHIFT);
}

void TMC5130_Set_CONST_Toff_Mode(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_CHM_MASK,
			TMC5130_CHM_SHIFT, value);
}

// Disable fast decay comparator
int32_t TMC5130_Get_FD_COMP(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_DISFDCC_MASK,
			TMC5130_DISFDCC_SHIFT);
}

void TMC5130_Set_FD_COMP(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_DISFDCC_MASK,
			TMC5130_DISFDCC_SHIFT, value);
}
...
int32_t TMC5130_Get_Chopper_HYS_FD_Time(TMC5130TypeDef *handle)
{
	...
	if (buffer & (1 << 14))
	{
		return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_HEND_MASK,
				TMC5130_HEND_SHIFT);
	}
	else
	{
...
void TMC5130_Set_Chopper_HYS_FD_Time(TMC5130TypeDef *handle, int32_t value)
{
	...
	if (buffer & (1 << 14))
	{
		TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_HEND_MASK,
				TMC5130_HEND_SHIFT, value);
	}
	else
	{
		if (value & (1 << 3))
...
int32_t TMC5130_Get_Chopper_HYS_Sine_Offset(TMC5130TypeDef *handle)
{
	...
	if (buffer & (1 << 14))
	{
		return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_HSTRT_MASK,
				TMC5130_HSTRT_SHIFT);
	}
	else
	{
...
void TMC5130_Set_Chopper_HYS_Sine_Offset(TMC5130TypeDef *handle, int32_t value)
{
	...
	{
		TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_HSTRT_MASK,
				TMC5130_HSTRT_SHIFT, value);
	}
	else
	{
		TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_OFFSET_MASK,
				TMC5130_OFFSET_SHIFT, value);
	}
}
...
{
	return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_TOFF_MASK,
			TMC5130_TOFF_SHIFT);
}

void TMC5130_Set_Chopper_TOff(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_TOFF_MASK,
			TMC5130_TOFF_SHIFT, value);
}

// smartEnergy current minimum (SEIMIN)
int32_t TMC5130_Get_SE_I_MIN(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_COOLCONF, TMC5130_SEIMIN_MASK,
			TMC5130_SEIMIN_SHIFT);
}

void TMC5130_Set_SE_I_MIN(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_COOLCONF, TMC5130_SEIMIN_MASK,
			TMC5130_SEIMIN_SHIFT, value);
}

// smartEnergy current down step
int32_t TMC5130_Get_SE_I_DWN_Step(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_COOLCONF, TMC5130_SEDN_MASK,
			TMC5130_SEDN_SHIFT);
}

void TMC5130_Set_SE_I_DWN_Step(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_COOLCONF, TMC5130_SEDN_MASK,
			TMC5130_SEDN_SHIFT, value);
}

// smartEnergy hysteresis
int32_t TMC5130_Get_SE_HYS(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_COOLCONF, TMC5130_SEMAX_MASK,
			TMC5130_SEMAX_SHIFT);
}

void TMC5130_Set_SE_HYS(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_COOLCONF, TMC5130_SEMAX_MASK,
			TMC5130_SEMAX_SHIFT, value);
}

// smartEnergy current up step
int32_t TMC5130_Get_SE_I_UP_Step(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_COOLCONF, TMC5130_SEUP_MASK,
			TMC5130_SEUP_SHIFT);
}

void TMC5130_Set_SE_I_UP_Step(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_COOLCONF, TMC5130_SEUP_MASK,
			TMC5130_SEUP_SHIFT, value);
}

// smartEnergy hysteresis start
int32_t TMC5130_Get_SE_HYS_Start(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_COOLCONF, TMC5130_SEMIN_MASK,
			TMC5130_SEMIN_SHIFT);
}

void TMC5130_Set_SE_HYS_Start(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_COOLCONF, TMC5130_SEMIN_MASK,
			TMC5130_SEMIN_SHIFT, value);
}

// stallGuard2 filter enable
int32_t TMC5130_Get_stallGuard2_Filter(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_COOLCONF, TMC5130_SFILT_MASK,
			TMC5130_SFILT_SHIFT);
}

void TMC5130_Set_stallGuard2_Filter(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_COOLCONF, TMC5130_SFILT_MASK,
			TMC5130_SFILT_SHIFT, value);
}

// stallGuard2 threshold
int32_t TMC5130_Get_stallGuard2_THRESH(TMC5130TypeDef *handle)
{
	int32_t tmp = TMC5130_FIELD_READ(handle, TMC5130_COOLCONF, TMC5130_SGT_MASK,
			TMC5130_SGT_SHIFT);
...
{
	TMC5130_FIELD_WRITE(handle, TMC5130_COOLCONF, TMC5130_SGT_MASK,
			TMC5130_SGT_SHIFT, value);
}

// VSense
int32_t TMC5130_Get_VSense(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_VSENSE_MASK,
			TMC5130_VSENSE_SHIFT);
}

void TMC5130_Set_VSense(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_VSENSE_MASK,
			TMC5130_VSENSE_SHIFT, value);
}

// smartEnergy actual current
int32_t TMC5130_Get_SE_Actual_I(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_DRVSTATUS, TMC5130_CS_ACTUAL_MASK,
...
{
	if (TMC5130_FIELD_READ(handle, TMC5130_SWMODE, TMC5130_SG_STOP_MASK,
...
{
	TMC5130_FIELD_WRITE(handle, TMC5130_SWMODE, TMC5130_SG_STOP_MASK,
			TMC5130_SG_STOP_SHIFT, (value) ? 1 : 0);
	int32_t tmp = MIN(0xFFFFF, (1 << 24) / ((value) ? value : 1));
...
{
	return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_RNDTF_MASK,
			TMC5130_RNDTF_SHIFT);
}

void TMC5130_Set_Random_TOff_Mode(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_RNDTF_MASK,
			TMC5130_RNDTF_SHIFT, value);
}

// Chopper synchronization
int32_t TMC5130_Get_Chopper_SYNC(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_CHOPCONF, TMC5130_SYNC_MASK,
			TMC5130_SYNC_SHIFT);
}

void TMC5130_Set_Chopper_SYNC(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_CHOPCONF, TMC5130_SYNC_MASK,
			TMC5130_SYNC_SHIFT, value);
}
...
{
	return TMC5130_FIELD_READ(handle, TMC5130_PWMCONF, TMC5130_PWM_GRAD_MASK,
			TMC5130_PWM_GRAD_SHIFT);
}

void TMC5130_Set_PWM_Gradient(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_PWMCONF, TMC5130_PWM_GRAD_MASK,
			TMC5130_PWM_GRAD_SHIFT, value);
	TMC5130_FIELD_WRITE(handle, TMC5130_GCONF, TMC5130_EN_PWM_MODE_MASK,
			TMC5130_EN_PWM_MODE_SHIFT, (value) ? 1 : 0);
}

// PWM amplitude
int32_t TMC5130_Get_PWM_Amplitude(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_PWMCONF, TMC5130_PWM_AMPL_MASK,
			TMC5130_PWM_AMPL_SHIFT);
}

void TMC5130_Set_PWM_Amplitude(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_PWMCONF, TMC5130_PWM_AMPL_MASK,
			TMC5130_PWM_AMPL_SHIFT, value);
}

// PWM frequency
int32_t TMC5130_Get_PWM_FREQ(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_PWMCONF, TMC5130_PWM_FREQ_MASK,
...
void TMC5130_Set_PWM_FREQ(TMC5130TypeDef *handle, int32_t value)
{
	if (value >= 0 && value < 4)
	{
		TMC5130_FIELD_WRITE(handle, TMC5130_PWMCONF, TMC5130_PWM_FREQ_MASK,
				TMC5130_PWM_FREQ_SHIFT, value);
	}
	else
	{
		//errors |= TMC_ERROR_VALUE;
...
{
	return TMC5130_FIELD_READ(handle, TMC5130_PWMCONF,
...
void TMC5130_Set_PWM_Auto_Scale(TMC5130TypeDef *handle, int32_t value)
{
	if (value >= 0 && value < 2)
	{
		TMC5130_FIELD_WRITE(handle, TMC5130_PWMCONF, TMC5130_PWM_AUTOSCALE_MASK,
				TMC5130_PWM_AUTOSCALE_SHIFT, value);
	}
	else
	{
		//errors |= TMC_ERROR_VALUE;
...
{
	return TMC5130_FIELD_READ(handle, TMC5130_PWMCONF, TMC5130_FREEWHEEL_MASK,
			TMC5130_FREEWHEEL_SHIFT);
}

void TMC5130_Set_Freewheeling_Mode(TMC5130TypeDef *handle, int32_t value)
{
	TMC5130_FIELD_WRITE(handle, TMC5130_PWMCONF, TMC5130_FREEWHEEL_MASK,
			TMC5130_FREEWHEEL_SHIFT, value);
}

// Load value
int32_t TMC5130_Get_Load_Value(TMC5130TypeDef *handle)
{
	return TMC5130_FIELD_READ(handle, TMC5130_DRVSTATUS, TMC5130_SG_RESULT_MASK,
