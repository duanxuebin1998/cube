...
void get_empty_weight(void)
{
	HAL_Delay(5000);
	weight_parament.empty_weight = abs(weight);
...
Weight_StateTypeDef determine_weight_status(void)
{
	weight_parament.current_weight = weight-weight_parament.empty_weight;
	printf("当前称重值\t%d\t", weight_parament.current_weight);
