...
typedef enum {
	...
	COM_NUM_PARA_DEBUG_START, /*CPU2基础参数 - 开始 CPU2存储的参数了*/
	...
	COM_NUM_PARA_LOCAL_START, /* 本机参数 - 开始 以下为CPU3存储的参数*/
    ...
    /* CPU3 通信配置参数（本机参数的一部分） */
    COM_NUM_CPU3_COM1_BAUDRATE,    // COM1 波特率
    COM_NUM_CPU3_COM1_DATABITS,    // COM1 数据位
    COM_NUM_CPU3_COM1_PARITY,      // COM1 校验
    COM_NUM_CPU3_COM1_STOPBITS,    // COM1 停止位
    COM_NUM_CPU3_COM1_PROTOCOL,    // COM1 协议类型

    COM_NUM_CPU3_COM2_BAUDRATE,    // COM2 波特率
    COM_NUM_CPU3_COM2_DATABITS,
    COM_NUM_CPU3_COM2_PARITY,
    COM_NUM_CPU3_COM2_STOPBITS,
    COM_NUM_CPU3_COM2_PROTOCOL,

    COM_NUM_CPU3_COM3_BAUDRATE,    // COM3 波特率
