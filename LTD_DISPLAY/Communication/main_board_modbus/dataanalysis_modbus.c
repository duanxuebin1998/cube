...
void WriteDeviceParamsToHoldingRegisters(int *HoldingRegisterArray)
{
    ...
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_WEIGHT_LOWER_LIMIT_RATIO, g_deviceParams.weight_lower_limit_ratio);
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_EMPTY_WEIGHT_UPPER_LIMIT, g_deviceParams.empty_weight_upper_limit);
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_EMPTY_WEIGHT_LOWER_LIMIT, g_deviceParams.empty_weight_lower_limit);
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_FULL_WEIGHT_UPPER_LIMIT, g_deviceParams.full_weight_upper_limit);
    ...
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_SP_MONITOR_POSITION, g_deviceParams.singlePointMonitoringPosition);
    ...
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_ALARM_LOW_AO, g_deviceParams.AlarmLowAO);
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_INITIAL_CURRENT_mA, g_deviceParams.InitialCurrent_mA);
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_AO_HIGH_CURRENT_mA, g_deviceParams.AOHighCurrent_mA);
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_AO_LOW_CURRENT_mA, g_deviceParams.AOLowCurrent_mA);
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_FAULT_CURRENT_mA, g_deviceParams.FaultCurrent_mA);
    WRITE_UINT32_TO_HOLDING(HOLDREGISTER_DEVICEPARAM_DEBUG_CURRENT_mA, g_deviceParams.DebugCurrent_mA);
...
void ReadDeviceParamsFromHoldingRegisters(int *HoldingRegisterArray)
{
    ...
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_WEIGHT_LOWER_LIMIT_RATIO, g_deviceParams.weight_lower_limit_ratio);
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_EMPTY_WEIGHT_UPPER_LIMIT, g_deviceParams.empty_weight_upper_limit);
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_EMPTY_WEIGHT_LOWER_LIMIT, g_deviceParams.empty_weight_lower_limit);
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_FULL_WEIGHT_UPPER_LIMIT, g_deviceParams.full_weight_upper_limit);
    ...
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_SP_MONITOR_POSITION, g_deviceParams.singlePointMonitoringPosition);
    ...
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_ALARM_LOW_AO, g_deviceParams.AlarmLowAO);
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_INITIAL_CURRENT_mA, g_deviceParams.InitialCurrent_mA);
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_AO_HIGH_CURRENT_mA, g_deviceParams.AOHighCurrent_mA);
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_AO_LOW_CURRENT_mA, g_deviceParams.AOLowCurrent_mA);
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_FAULT_CURRENT_mA, g_deviceParams.FaultCurrent_mA);
    READ_UINT32_FROM_HOLDING(HOLDREGISTER_DEVICEPARAM_DEBUG_CURRENT_mA, g_deviceParams.DebugCurrent_mA);
